...
import { Loader2, User, Mail, KeyRound, CheckCircle } from 'lucide-react'
    ...
    <div className="min-h-screen bg-black text-gray-200 flex flex-col">
      <div className="flex-grow flex flex-col items-center justify-center px-4 py-10">
        ...
        <div className="w-full max-w-md bg-gradient-to-b from-[#0C0C0C] to-[#080808] border border-gray-800/60 rounded-3xl shadow-lg p-7 md:p-9 transform transition-all duration-300 hover:shadow-xl">
          <h1 className="text-xl md:text-2xl text-white font-semibold mb-7 text-center">Create an Account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-xs text-gray-500 mt-4">
              By registering, you agree to our <Link href="#" className="text-blue-400 hover:text-blue-300">Terms of Service</Link> and <Link href="#" className="text-blue-400 hover:text-blue-300">Privacy Policy</Link>
            </div>
          </form>
